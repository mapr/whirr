 ...
 */
public class MapRServiceTeraSortBenchmark {
  
  private static final Logger LOG =
    LoggerFactory.getLogger(MapRServiceTeraSortBenchmark.class);
  ...
  public static void setUp() throws Exception {
    controller = MapRServiceController.getInstance("whirr-mapr-test.properties");
