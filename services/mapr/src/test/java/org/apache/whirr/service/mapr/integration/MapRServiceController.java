...
public class MapRServiceController {
  ...
  private static final Logger LOG =
    LoggerFactory.getLogger(MapRServiceController.class);

  private static final Map<String, MapRServiceController> INSTANCES =
    new HashMap<String, MapRServiceController>();
  
  public static MapRServiceController getInstance(String config) throws ConfigurationException {
    if (!INSTANCES.containsKey(config)) {
      PropertiesConfiguration configuration = new PropertiesConfiguration(config);
      INSTANCES.put(config, new MapRServiceController(configuration));
    }
  ...
  private MapRServiceController(org.apache.commons.configuration.Configuration configuration) {
  ...
  public synchronized void startup() throws Exception {
    ...
    proxy = new MapRProxy(clusterSpec, cluster);
    proxy.start();
